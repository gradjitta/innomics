...
<body>
<div id="aboutteja">
<form name="aboutteja_form" action="insert_aboutteja.php" method="post" >
<table width="600px" border="0">
<tr>
<td id="1" style="color:lightblue">Your firstimpression on me:</td>
</tr>
<tr>
<td><textarea rows="5" cols="70" name="firstimp" onfocus="colorchange(1)" onblur="cancelcolorchange(1)"> </textarea></td>
</tr>
<tr>
</tr>
<tr>
...
<tr>
<td id="2" style="color:lightblue">what will you say to your friends about me if u have to???
</td>
</tr>
<tr>
<td><textarea rows="5" cols="70" name="comment_on_me" onfocus="colorchange(2)" onblur="cancelcolorchange(2)"></textarea></td>
</tr>
<tr>
</tr>
<tr width="100%" >
